...
from pipelines.utils.uiex_ernie_layout.vocab import Vocab
...
class ChatTemplateMixin:
    ...
    def apply_chat_template(
        ...
        **tokenizer_kwargs
        ...
        Returns:
            str | dict[str, numpy.ndarray]: return the result of applied data
        """
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *args, **kwargs):
        ...
        cache_dir = pretrained_model_name_or_path if cache_dir is None else cache_dir

        chat_template_file = os.path.join(cache_dir, "chat_template.json")
    ...
    def save_resources(self, save_directory):
        ...
        if self.chat_template is not None:
            chat_template_file = os.path.join(save_directory, "chat_template.json")
